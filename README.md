...
[![CI](https://github.com/trfore/docker-centos8-systemd/actions/workflows/ci.yml/badge.svg)](https://github.com/trfore/docker-centos8-systemd/actions/workflows/ci.yml)
...
```sh
docker pull trfore/docker-centos8-systemd
```
...
1. Install [docker]
2. Clone the repo, `git clone https://github.com/trfore/docker-centos8-systemd.git`
3. `cd` into the directory
4. Run `docker build --tag trfore/docker-centos8-systemd .`
...
1. Install [docker]
2. Build an image locally (see above) or pull from Docker Hub: `docker pull trfore/docker-centos8-systemd:latest`
3. Run a container from the image: `docker run -d -it --name centos8-systemd --privileged --cgroupns=host --tmpfs=/run --tmpfs=/tmp --volume=/sys/fs/cgroup:/sys/fs/cgroup:ro trfore/docker-centos8-systemd:latest`
4. Use it, ex: `docker exec -it centos8-systemd /bin/bash`
